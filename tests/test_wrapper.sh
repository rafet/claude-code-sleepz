...
HOOK_TS=$(python3 -c "import time; print(int((time.time() - 120) % 86400))")
...
HOOK_TS=$(python3 -c "import time; print(int((time.time() - 0.5) % 86400))")
...
HOOK_TS=$(python3 -c "import time; print(int(time.time() % 86400))")
